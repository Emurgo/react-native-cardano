...
fn handle_error<F: FnOnce() -> R + panic::UnwindSafe, R>(error: *mut *const c_char, err_val: R, func: F) -> R {
...
pub extern "C" fn xwallet_from_master_key_safe(
  input_ptr: *const c_uchar, output_ptr: *mut c_uchar, error: *mut *const c_char
) -> i32 {
